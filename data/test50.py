...
cases=[
 ('#86',{n('沙滩车'):4,n('复仇者'):6},{n('高级武装'):2,n('合声'):5},'R',10),
 ('#55',{n('矿脉'):5,n('炮击'):4},{n('沉沙'):3,n('沸血'):3},'L',10),
 ('#201',{n('门'):3,n('妒'):4},{n('高级武装'):3,n('炮击'):4},'L',10),
 ('#103',{n('妒'):4,n('水遁'):3},{n('庞贝'):2},'R',10),
 ('#12',{n('散华'):4},{n('炮击'):3},'L',10),
]
t0=time.time()
out=[]
...
out.append(f'总耗时 {time.time()-t0:.0f}s')
with open(r'G:\314\CannotMax-main\data\test50.txt','w',encoding='utf-8') as f:
    f.write('\n'.join(out))
print('done')
