...
from .paths import APP_CONFIG_JSON
...
RECOGNITION_PARAMS = {
    "ADB": {
        "crop_regions": ((0.2464, 0.8410), (0.7542, 0.9510)),
        "avatar_regions": (
    ...
    "PC": {
        "crop_regions": ((0.2703, 0.8556), (0.7281, 0.9565)),
        "avatar_regions": (
...
def _load_app_config() -> dict[str, Any]:
    ...
    config_path = APP_CONFIG_JSON
    if not config_path.exists():
        logger.warning("%s 不存在，使用内置默认配置并创建", APP_CONFIG_JSON)
