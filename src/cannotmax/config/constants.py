...
PC_DEFAULT_AVATAR_REGIONS = (
    (0.0000, 1.0000, 0.1229, 0.0000),
    (0.1206, 0.0000, 0.2435, 1.0000),
    (0.2412, 1.0000, 0.3652, 0.0000),
    (0.6348, 1.0000, 0.7588, 0.0000),
    (0.7554, 0.0000, 0.8794, 1.0000),
    (0.8760, 1.0000, 1.0000, 0.0000),
)

# PC 端 975x119 标准怪物条内数字区域相对坐标
PC_DEFAULT_NUMBER_REGIONS = (
    (0.0523, 1.0000, 0.1411, 0.7523),
    (0.1729, 0.7523, 0.2617, 1.0000),
    (0.2935, 1.0000, 0.3823, 0.7523),
    (0.6177, 1.0000, 0.7065, 0.7523),
    (0.7383, 0.7523, 0.8271, 1.0000),
    (0.8589, 1.0000, 0.9477, 0.7523),
)
