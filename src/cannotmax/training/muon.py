"""
Muon and Lion optimizers for neural network training.

Muon: Scalable optimizer from "Muon is Scalable for LLM Training"
Lion:  EvoLved Sign Momentum from Google
"""
