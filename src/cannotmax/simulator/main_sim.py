...
class SandboxSimulator:
    ...
    def on_mouse_drag(self, event):
        if self.selected_monster_for_drag and self.state_machine.state in [
            ...
            self.selected_monster_for_drag.target_deployment_position = FastVector(
    ...
    def create_widgets(self):
        ...
        self.pause_button = tk.Button(
            top_control_frame, text="暂停", command=self.toggle_pause, state=tk.DISABLED
        )
    ...
    def draw_grid(self):
        ...
        self.canvas.create_rectangle(
            0, 0, self.cell_size, self.canvas_height, fill=soft_red_fill, outline=""
        )
