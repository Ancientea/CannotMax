...
class CannotModel:
            ...
            for model_file_path in models:
                ...
                if match:
                    ...
                    try:
                        ...
                        valid_models.append(
                            (model_time, priority.get(model_type, 3), model_file_path)
                        )
                    except ValueError:
    ...
    def get_prediction(
        self, left_counts: np.typing.ArrayLike, right_counts: np.typing.ArrayLike
    ):
    ...
    def get_prediction_with_terrain(self, full_features: np.typing.ArrayLike):
        ...
        right_monsters = full_features[
            MONSTER_COUNT + FIELD_FEATURE_COUNT : MONSTER_COUNT * 2
            + FIELD_FEATURE_COUNT
        ]  # 1R-77R
        right_terrain = full_features[
            MONSTER_COUNT * 2 + FIELD_FEATURE_COUNT : MONSTER_COUNT * 2
