...
CONFIG = {
    ...
    "icon_file": r"src/resources/assets/icons/icon_64x64.ico",  # 图标文件路径
    "output_dir": "build/dist",  # 输出目录
    "console": True,
    "add_data": [  # 需要打包的附加数据
    ...
    for item in CONFIG["copy_files"]:
        ...
        try:
            if src.is_dir():
                ...
                if src.name == "images" and "resources" in str(src):
